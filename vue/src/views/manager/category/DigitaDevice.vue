      ...
      <el-card :body-style="{ padding: '0px' }" v-for="product in products" :key="product.id"
        ...
        <div style="padding: 14px; width: 250px; ">
          ...
          <div class="bottom clearfix">
            ...
            <span style="font-size: 14px; color: rgb(244, 73, 61); font-weight: bold;">{{
                product.price
              }}</span>
            <el-button type="text" class="button" style="color: rgb(25,156,96)"
                       @click="check(product.id)">查看
            </el-button>
          </div>
          ...
          <div style=";display: flex;">
            ...
            <div>
              <div style="height: 50%; font-size: 12px; color:rgb(122,122,122) ;">{{ product.user_nickname }}</div>
              <div style="height: 50%; font-size: 12px; color: rgb(190,190,190);">发布于{{ product.create_time }}</div>
            </div>
          </div>
        </div>
      </el-card>
