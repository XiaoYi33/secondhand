      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
        <el-form :model="user" style="width: 80%;" :rules="rules" ref="loginRef">
          ...
          <div style="display: flex;">
            ...
            <div style="flex: 1; text-align: right;"><span style="color:#409EFF; cursor: pointer;" @click="handleForgetPassword">忘记密码</span></div>
          </div>
        </el-form>
      </div>
    ...
    <el-dialog title="忘记密码" :visible.sync="forgetPassDialogVis" width="30%">
      <el-form :model="forgetUserForm" label-width="80px" style="padding-right: 20px;">
        ...
        <el-form-item label="邮箱">
          <el-input v-model="forgetUserForm.email" autocomplete="off" placeholder="请输入邮箱"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="forgetPassDialogVis = false">取 消</el-button>
        <el-button type="primary" @click="resetPassowrd">确 定</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    ...
    return {
      forgetUserForm: {},//忘记密码用户信息
      forgetPassDialogVis: false,//控制忘记密码弹窗显示
      code: '',//验证码组件传递过来的Code
      user: {
        username: '',
        password: '',
