<template>
  <div style="height: 100vh; display: flex; align-items: center; justify-content: center; background-color: #67C23A;">
    ...
    <!-- 把这个flex平均拆成两部分 -->
    <div
      style="display: flex; background-color: white; width: 20%; height: 700px; border-radius: 5px; overflow: hidden;">
        ...
        <el-form :model="user" style="width: 80%;" :rules="rules" ref="registerRef">
          ...
          <el-form-item prop="confirmPassword">
            <el-input prefix-icon="el-icon-circle-check" size="medium" show-password style="flex: 1;"
              v-model="user.confirmPassword" placeholder="请确认密码"></el-input>
          </el-form-item>
          <el-form-item prop="nickname">
            <el-input prefix-icon="el-icon-circle-check" size="medium" style="flex: 1;"
              v-model="user.nickname" placeholder="请输入昵称"></el-input>
          </el-form-item>
          ...
          <el-form-item prop="wechat">
            <el-input prefix-icon="el-icon-circle-check" size="medium" style="flex: 1;"
              v-model="user.wechat" placeholder="请输入微信"></el-input>
          </el-form-item>
          <el-form-item prop="phone">
            <el-input prefix-icon="el-icon-circle-check" size="medium" style="flex: 1;"
              v-model.number="user.phone" placeholder="请输入电话"></el-input>
          </el-form-item>
          <el-form-item prop="email">
            <el-input prefix-icon="el-icon-circle-check" size="medium" style="flex: 1;"
              v-model="user.email" placeholder="请输入邮箱"></el-input>
          </el-form-item>
          <el-form-item>
